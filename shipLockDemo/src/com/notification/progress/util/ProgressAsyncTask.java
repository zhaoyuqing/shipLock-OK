...
public class ProgressAsyncTask extends AsyncTask<Object, Integer, Object> {
	 ...
	 * @param notifyId
	 */
	public ProgressAsyncTask(Handler handler, String fileUrl,
	...
	public ProgressAsyncTask(Handler handler, String fileUrl,
		...
		this(handler, fileUrl, fileSavePath, fileName, isGreatVersion, nm,
				null, notifyId);
	...
	private void notifyLowVersionNotification(Serializable speed,
		...
		case NOTIFICATION_STATUS_FLAG_DONE:// 完成
			...
			msg.what = 0;
			msg.obj = this.fileSavePath + "/"
					+ this.fileUrl.substring(this.fileUrl.lastIndexOf("/") + 1);
			this.m_handler.sendMessageDelayed(msg, 1000);
