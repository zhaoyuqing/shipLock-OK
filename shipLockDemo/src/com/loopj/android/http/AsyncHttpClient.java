...
public class AsyncHttpClient {
   ...
   /**
    ...
    // add By zhaoyuqing
    public void postMine(String url, StringEntity params, AsyncHttpResponseHandler responseHandler) {
        postMine(null, url, params, responseHandler);
    }
    public void postMine(Context context, String url, StringEntity params, AsyncHttpResponseHandler responseHandler) {
